...
import logo from "../images/RadiantRealms-Logo-no-stars.png";
import heroGif from "../images/testing-2.gif";
import showCase from "../images/showcase.png";
import giftest from "../images/giftest.gif";
import slickCarousel_1 from "../images/sprite_1_1_copia00893.png";
import slickCarousel_2 from "../images/sprite_1_1_copia01063.png";
import slickCarousel_3 from "../images/sprite_1_1_copia01083.png";
import slickCarousel_4 from "../images/sprite_1_1_copia01113.png";
import slickCarousel_5 from "../images/sprite_1_1_copia01012.png";
import slickCarousel_6 from "../images/sprite_1_1_copia01083.png";
import team_1 from "../images/team/24.png";
import team_2 from "../images/team/13.png";
import team_3 from "../images/team/17.png";
import team_4 from "../images/team/74.png";
import team_5 from "../images/team/38.png";
          ...
          <div className="hero-overlay">
            ...
            <div className="banner">
              <div className="relative banner-image mx-auto mb-2">
                <img src={heroGif} alt="banner" className="img-fluid w-100" />
              </div>
              {/* banner image end  */}
                ...
                <div className="card video-card">
                  ...
                  <div className="carousel__wrap mt-3">
                    <div className="owl-carousel">
                      <div
                        data-video="pWfYG2AxDU4"
                        className="item video-thumb active"
                      >
                        <img src="https://img.youtube.com/vi/pWfYG2AxDU4/hqdefault.jpg" />
                      </div>
                      <div
                        data-video="N3QJQLd9IS8"
                        className="item video-thumb"
                      >
                        <img src="https://img.youtube.com/vi/N3QJQLd9IS8/hqdefault.jpg" />
                      </div>
                      <div
                        data-video="N3QJQLd9IS8"
                        className="item video-thumb"
            ...
            <div className="container">
              <div className="row align-items-center">
                ...
                <div className="col-lg-6 text-center text-lg-left pl-0 pl-lg-5">
                  <img src={showCase} alt="what are" className="img-fluid" />
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="col-md-12">
                  <Slider {...settings}>
                    <div className="img-item">
                      <img src={slickCarousel_1} alt="fro" />
                    </div>
                    <div className="img-item">
                      <img src={slickCarousel_2} alt="fro" />
                    </div>
                    <div className="img-item">
                      <img src={slickCarousel_3} alt="fro" />
                    </div>
                    <div className="img-item">
                      <img src={slickCarousel_4} alt="fro" />
                    </div>
                    <div className="img-item">
                      <img src={slickCarousel_5} alt="fro" />
                    </div>
                    <div className="img-item">
                      <img src={slickCarousel_6} alt="fro" />
                    </div>
                  </Slider>
                </div>
              </div>
